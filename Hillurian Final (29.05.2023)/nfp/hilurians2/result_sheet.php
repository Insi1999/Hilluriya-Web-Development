...
<body><br>
    <div class="container">
        ...
        <div align="right"><button class='btn btn-sm btn-primary' onclick='window.print()' id='print-btn' name="print-btn"><span class="material-symbols-outlined">
            print</span></button></div>
            <!-- <div align="right"><button onclick='window.print()' class='btn btn-sm btn-primary' id='print-btn'>Print &nbsp <i class="fa fa-floppy-o" aria-hidden="true"></i> </a></button></div> -->
    ...
    <h1 class="display-6"><span class="sclname"> BT/BC/Hiluriya Vidyalaya <br> Kattankudy - 03</h1></span> <br>
...
<br><br></span>   
    <table align="center" cellpadding="2" border="3" class="table" style="width:100%;height: 30%;">
        ...
        <tr align="center" class="hd2" valign="middle">
            <td><b>06</b></td>
            <td align="left"><b>Islam</b></td>
            <td><b><?php echo $row['Islam']; ?></b></td>
        </tr>
        <tr align="center" class="hd2" valign="middle">
            <td><b>07</b></td>
            <td align="left"><b><?php echo $row['first']; ?>l</b></td>
            <td><b><?php echo $row['first_re']; ?></b></td>
        </tr>
        <tr align="center" class="hd2" valign="middle">
            <td><b>08</b></td>
            <td align="left"><b><?php echo $row['second']; ?></b></td>
            <td><b><?php echo $row['sec_re']; ?></b></td>
        </tr>
        <tr align="center" class="hd2" valign="middle">
            <td><b>09</b></td>
            <td align="left"><b><?php echo $row['third']; ?></b></td>
            <td><b><?php echo $row['third_re']; ?></b></td>
        </tr>

    </table>
    <br><br><br>
    <table align="right" cellpadding="2" class="tt">
